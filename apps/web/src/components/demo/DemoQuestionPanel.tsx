...
interface DemoQuestionPanelProps {
...
export function DemoQuestionPanel({ question, answer, isActive, compact }: DemoQuestionPanelProps) {
  const { updateAnswer } = useDemoStore();
  ...
  return (
    <div className={cn(
      ...
      <div className="mb-4">
        ...
        {question.crmFieldMapping && (
          <p className="text-xs text-purple-500 mt-1">
            CRM: {question.crmFieldMapping}
          </p>
        )}
      </div>
